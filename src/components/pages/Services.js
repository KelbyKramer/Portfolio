...
export default function Services() {
    return (
        ...
        <div class="flex justify-center"><a href="KelbyKramerResume.pdf" download="KelbyKramerResume.pdf">Download full resume here</a></div>
        ...
        <div class="flex justify-center items-center my-10">
            ...
            <div class="flex justify-center mb-20"><a href="KelbyKramerResume.pdf" download="KelbyKramerResume.pdf">Download full resume here</a></div>
        </div>
        </>
    )
}